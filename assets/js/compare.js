document.addEventListener('DOMContentLoaded', () => {
    ...
    compareBtn.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            generateMockReport(fileOld.name, fileNew.name);
        }, 2000);
    });

    function generateMockReport(oldName, newName) {
        ...
        // Mock data
        const fields = [
            { field: "Seller Name", old: "Ramesh Kumar", new: "Ramesh Kumar", status: "Match", class: "status-match" },
            { field: "Buyer Name", old: "Suresh Pillai", new: "Suresh Pillai", status: "Match", class: "status-match" },
            { field: "Survey Number", old: "45/2A", new: "45/2B", status: "Mismatch", class: "status-mismatch" },
            { field: "Extent", old: "1200 sq.ft", new: "1200 sq.ft", status: "Match", class: "status-match" },
            { field: "Village", old: "Hasthinapuram", new: "Not Found", status: "Missing", class: "status-missing" }
        ];
